...
class Transform(nn.Module):
    ...
    def _needs_transform_list(self, flat_inputs: List[Any]) -> List[bool]:
        ...
        transform_pure_tensor = not has_any(
            flat_inputs, tv_tensors.Image, tv_tensors.Video, PIL.Image.Image
        )
    ...
    def extra_repr(self) -> str:
        ...
        for name, value in self.__dict__.items():
            ...
            if not isinstance(
                value, (bool, int, float, str, tuple, list, enum.Enum)
            ):
                continue
    ...
    def __init_subclass__(cls) -> None:
        ...
        if cls._v1_transform_cls is not None and hasattr(
            cls._v1_transform_cls, "get_params"
        ):
    ...
    def __prepare_scriptable__(self) -> nn.Module:
        ...
        return self._v1_transform_cls(
            **self._extract_params_for_v1_transform()
        )
